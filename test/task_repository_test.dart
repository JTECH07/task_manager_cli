...
void main() {
  ...
  setUp(() async {
    final tempDir = await Directory.systemTemp.createTemp('task_test_');
  ...
  group('TaskRepository Tests', () {
    ...
    test('Should get a task by ID', () async {
      final task = Task(id: '2', title: 'Find Me');
    ...
    test('Should update a task', () async {
      final task = Task(id: '3', title: 'Original Title');
    ...
    test('Should delete a task', () async {
      final task = Task(id: '4', title: 'Delete Me');
    ...
    test(
      'Should throw TaskNotFoundException when deleting non-existent task',
      () async {
        expect(
